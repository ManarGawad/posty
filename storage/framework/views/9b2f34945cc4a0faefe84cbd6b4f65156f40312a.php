...
<div class="mb-4">
    <a href="<?php echo e(route('user.posts', $post->user)); ?>" class="font-bold"><?php echo e($post->user->name); ?></a> <span class="text-grey-600 text-sm"><?php echo e($post->created_at->diffForHumans()); ?></span>
...
</div><?php /**PATH C:\Users\Manar\posty\resources\views/components/post.blade.php ENDPATH**/ ?>